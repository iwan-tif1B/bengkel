                    ...
                    <table class="table table-bordered">
                      ...
                      @foreach($bukuTamus as $bukuTamu)
                        <tr>
                          ...
                          <td><a href="{{ Storage::url($bukuTamu->gambar) }}" target="_blank">Lihat Gambar</a></td>
                          <td><a href="{{ asset('storage/images/bukti_pembayaran/'.$bukuTamu->Bukti_Tf) }}" target="_blank">Lihat Bukti TF</a></td>
